...
return (
    <div className = 'grid-container'>
        <div className='main'> 
            <input type='text' onChange= {probs.edit} value= {probs.title} placeholder='Title' name='title' autoFocus/> <br/>
        ...
        <div className='util'>
            ...
            <input className='checker' type = "checkBox" title="mark as completed" onChange= {probs.edit} value={probs.status} name='status' /><br/>
